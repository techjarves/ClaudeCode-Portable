import { existsSync, mkdirSync, readFileSync, writeFileSync, renameSync, rmSync, realpathSync, readdirSync, copyFileSync, statSync, chmodSync } from 'node:fs';
...
export function repairNativeBinary(directory = RUNTIME) {
  const executable = executableAt(directory);
